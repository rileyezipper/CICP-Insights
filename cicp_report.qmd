...
viz_path <- "outputs_20251031/visualizations"
...
wage_percentiles <- wage_data %>%
  filter(display_level >= 2, year == recent_year - 1, 
...
knitr::include_url("estab_output_2022/plots/O_new_startups_by_type_interactive.html", height = "1000px")
```
:::
